...
def get_data_loaders(
    ...
    "train": transforms.Compose([
        ...
        transforms.GaussianBlur(kernel_size=3),  # Small blur
        transforms.RandAugment(num_ops=2, magnitude=3, interpolation=transforms.InterpolationMode.BILINEAR),  # Reduced intensity
        transforms.ToTensor(),
